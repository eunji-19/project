    ...
    return AuthService
        ...
        .then((response) => {
            ...
            if (axios.isAxiosError(error)) {
                ...
                dispatch({
                    type: SET_MESSAGE, payload: result,
                    // payload: message,
                });
            }
            // const message =   (error.response &&     error.response.data &&
            // error.response.data.message) ||   error.message ||   error.toString();
            // dispatch({   type: REGISTER_FAIL, }); dispatch({   type: SET_MESSAGE,
            // payload: message, });
...
: any) => {
    return AuthService
        ...
        .then((data) => {
            ...
            // const message =   (error.response &&     error.response.data &&
            // error.response.data.message) ||   error.message ||   error.toString();
            // dispatch({   type: LOGIN_FAIL, }); dispatch({   type: SET_MESSAGE,   payload:
            // new Error(error), });
