 ...
 * Recommend
 */
export const GET_RECOMMEND_BOOK_START = 'recommend/GET_RECOMMEND_BOOK_START' as const;
export const GET_RECOMMEND_BOOK_SUCCESS = 'recommend/GET_RECOMMEND_BOOK_SUCCESS' as const;
export const GET_RECOMMEND_BOOK_ERROR = 'recommend/GET_RECOMMEND_BOOK_ERROR' as const;
